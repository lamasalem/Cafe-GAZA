    ...
    <div class="card card-primary">
        ...
        <form>
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="table_number" name="table_number"
                        value="{{ $diningTable->table_number }}">
                </div>
                <div class="form-group">
                    <label for="capacity">Capacity</label>
                    <input type="number" class="form-control" id="capacity" name="capacity"
                        value="{{ $diningTable->capacity }}">
                </div>
                <div class="form-group">
                    <label for="status">Status</label>
                    <select class="form-control" id="status" name="status">
                        <option value="available" {{ $diningTable->status == 'available' ? 'selected' : '' }}>Available
                        </option>
            ...
            <div class="card-footer">
                <button type="button" onclick="performUpdate('{{ $diningTable->id }}')"
