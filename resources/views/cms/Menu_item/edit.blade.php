    ...
    <form>
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="Item_Name" name="Item_Name" value="{{ $menuItem->Item_Name }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" class="form-control" id="Price" name="Price" value="{{ $menuItem->Price }}">
            </div>
            <div class="form-group">
                <label for="Status">Status</label>
                <select class="form-control" id="Status" name="Status">
                    <option value="available" {{ $menuItem->Status == 'available' ? 'selected' : '' }}>Available</option>
                    <option value="unavailable" {{ $menuItem->Status == 'unavailable' ? 'selected' : '' }}>Unavailable</option>
                </select>
            </div>
            <div class="form-group">
