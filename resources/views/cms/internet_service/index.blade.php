                ...
                <tbody>
                    @foreach($internetServices as $internetService)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('internet-services.show', $internetService->id) }}"
                                    class="action-btn btn-show">
                                    <i class="fas fa-eye"></i> Show
                                </a>
                                <a href="{{ route('internet-services.edit', $internetService->id) }}"
                                    class="action-btn btn-edit">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <a href="#" onclick="performDestroy({{ $internetService->id }}, this)"
