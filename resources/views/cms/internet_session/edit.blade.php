            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control" id="Start_Time" name="Start_Time"
                        value="{{ $internetSession->Start_Time }}">
                </div>
                <div class="form-group">
                    <label for="End_Time">End Time</label>
                    <input type="datetime-local" class="form-control" id="End_Time" name="End_Time"
                        value="{{ $internetSession->End_Time }}">
                </div>
                <div class="form-group">
                    <label for="Access_Code">Access Code</label>
                    <input type="text" class="form-control" id="Access_Code" name="Access_Code"
                        value="{{ $internetSession->Access_Code }}">
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" id="Status" name="Status">
                        ...
                        <option value="cancelled" {{ $internetSession->Status == 'cancelled' ? 'selected' : '' }}>Cancelled
                        </option>
                    </select>
                </div>
            </div>
            <div class="card-footer">
                <button type="button" onclick="performUpdate('{{ $internetSession->id }}')"
