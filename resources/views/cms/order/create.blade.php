    ...
    <form>
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" class="form-control" id="Total_Amount" name="Total_Amount" placeholder="Enter Total Amount">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="Dining_Tables_ID" name="Dining_Tables_ID">
                    @foreach($diningTables as $diningTable)
                        <option value="{{ $diningTable->id }}">Table {{ $diningTable->table_number }} (Capacity: {{ $diningTable->capacity }})</option>
                    @endforeach
                </select>
            </div>
        </div>
